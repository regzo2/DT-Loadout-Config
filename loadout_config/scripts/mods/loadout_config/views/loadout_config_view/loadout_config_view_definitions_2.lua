...
local weapon_card_passes = {
    ...
    },
    {
        ...
        change_function = function(content, style)
            ...
            if current_card_item.display_name == "n/a" then
                content.text = "Attachment"
                return
            end

            local display_name = Localize(current_card_item.display_name)
            if mod._weapon_naming_convention == "simple" and current_card_item.weapon_template then
                local weapon_family_name = "loc_weapon_family_" .. current_card_item.weapon_template
                local weapon_pattern_name = "loc_weapon_pattern_" .. current_card_item.weapon_template
                local weapon_mark_name = "loc_weapon_mark_" .. current_card_item.weapon_template
                display_name = Localize(weapon_family_name) .. " • " .. Localize(weapon_mark_name)
            elseif mod._weapon_naming_convention == "modern" and current_card_item.weapon_template then
                local weapon_family_name = "loc_weapon_family_" .. current_card_item.weapon_template
                local weapon_pattern_name = "loc_weapon_pattern_" .. current_card_item.weapon_template
                local weapon_mark_name = "loc_weapon_mark_" .. current_card_item.weapon_template
                display_name = Localize(weapon_family_name) .. "\n" .. Localize(weapon_pattern_name) .. " • " .. Localize(weapon_mark_name)
            end
